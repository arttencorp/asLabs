        ...
        <section className="py-20 sm:py-28">
          <div className="mx-auto grid max-w-7xl gap-10 px-5 sm:px-8 lg:grid-cols-[.92fr_1.08fr] lg:items-center">
            <div className="relative min-h-[480px]">
              <div className="absolute inset-y-0 left-0 right-8 overflow-hidden rounded-[34px]"><Image src="/ecuador/carolina-millenium.jpg" alt="Edificio Carolina Millenium, sede de AS Labs en Quito" fill className="object-cover object-center" sizes="(min-width:1024px) 44vw,100vw" /><div className="absolute inset-0 bg-gradient-to-t from-[#09251e]/75 via-transparent to-transparent" /></div>
