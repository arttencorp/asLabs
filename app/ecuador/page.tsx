...
export const metadata: Metadata = {
  ...
  description: "Sede de AS Labs en Quito: biología molecular, formulaciones bacterianas, plantines in vitro y catálogo de cepas identificadas.",
  keywords: ["laboratorio biología molecular Quito", "PCR Ecuador", "secuenciación Ecuador", "formulaciones bacterianas Quito", "plantines in vitro Ecuador", "cepas identificadas Ecuador", "Fusarium banano Ecuador", "AS Labs Ecuador"],
...
export default function EcuadorPage() {
  const structuredData = {
    ...
    description: "Biología molecular, formulaciones bacterianas, plantines in vitro y cepas identificadas en Quito, Ecuador.",
    ...
    hasOfferCatalog: { "@type": "OfferCatalog", name: "Servicios AS Labs Ecuador", itemListElement: [{ "@type": "Offer", itemOffered: { "@type": "Service", name: "Biología molecular" } }, { "@type": "Offer", itemOffered: { "@type": "Service", name: "Formulaciones bacterianas" } }, { "@type": "Offer", itemOffered: { "@type": "Service", name: "Plantines in vitro" } }, { "@type": "Offer", itemOffered: { "@type": "Product", name: "Cepas identificadas molecularmente" } }] },
  }
