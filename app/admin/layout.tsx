...
import { ChartColumn, Store, FileText, FileBadge, FileSpreadsheet, Package, Package2, Users, LogOut, FileInput, Signature, FlaskConical } from "lucide-react"
...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  const navItems = [
    ...
    { name: "Recepción de Muestras", href: "/admin/recepcion", icon: FlaskConical },
