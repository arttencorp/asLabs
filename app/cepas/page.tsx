...
export const metadata: Metadata = constructMetadata({
  ...
  description: "Cepas identificadas y referencias ATCC disponibles para proyectos de investigación, docencia y tesis en Perú.",
...
const comparison = [
  ...
  { label: "Acceso", identified: "Cultivo bajo solicitud", atcc: "Evaluación según disponibilidad y proyecto declarado" },
      ...
      <main className="overflow-hidden bg-[#f5f7f4] text-[#173428]">
        ...
        <section data-navbar-theme="light" className="mx-auto max-w-6xl px-4 py-20 md:py-28">
          ...
          <div className="mt-12 grid gap-5 lg:grid-cols-2">
            ...
            <Link href="/cepas/atcc" className="group relative flex min-h-[500px] flex-col overflow-hidden rounded-[2rem] border border-[#dce5de] bg-white p-7 transition duration-300 hover:-translate-y-1 hover:shadow-2xl md:p-9">
              ...
              <div className="relative mt-16"><p className="text-xs font-bold uppercase tracking-[.18em] text-[#4e7d5f]">Cepas ATCC</p><h3 className="mt-3 text-3xl font-bold tracking-[-.03em] md:text-4xl">Referencias para investigación y tesis</h3><p className="mt-4 max-w-xl text-sm leading-6 text-[#687970] md:text-base">Contamos con microorganismos de referencia internacional para trabajos académicos y científicos que requieren identidad y trazabilidad.</p></div>
              <ul className="relative mt-8 grid gap-3 text-sm text-[#53685d] sm:grid-cols-2">
                <Feature text="Referencia documentada" dark /><Feature text="Información técnica" dark /><Feature text="Uso científico" dark /><Feature text="Consulta de disponibilidad" dark />
              </ul>
        ...
        <section data-navbar-theme="light" className="bg-[#eaf0ea] px-4 py-20 md:py-28">
          <div className="mx-auto max-w-6xl">
            <div className="grid gap-10 lg:grid-cols-[.68fr_1.32fr] lg:items-end"><div><p className="text-xs font-bold uppercase tracking-[.2em] text-[#4e7d5f]">Comparación rápida</p><h2 className="mt-4 text-3xl font-bold tracking-[-.035em] md:text-5xl">Encuentra la opción adecuada</h2></div><p className="max-w-2xl text-base leading-7 text-[#687970] lg:justify-self-end">La elección depende del uso previsto. Las referencias ATCC están destinadas exclusivamente a investigación, docencia y trabajos de tesis.</p></div>
