...
const allCepas: Cepa[] = [
  {
    ...
    presentaciones: [
      { id: "1-1", tipo: "Placa", medio: "Agar Nutritivo", precio: 14.00 },
      { id: "1-2", tipo: "Placa", medio: "TSA", precio: 16.00 },
      { id: "1-3", tipo: "Frasco", medio: "Agar Nutritivo", precio: 20.00 },
      { id: "1-4", tipo: "Caldo", volumen: "100ml", precio: 16.00 },
      { id: "1-5", tipo: "Caldo", volumen: "500ml", precio: 50.00 },
    ],
    viabilidad: "> 96%",
  ...
  },
  {
    ...
    presentaciones: [
      { id: "2-1", tipo: "Placa", medio: "Agar Nutritivo", precio: 15.00 },
      { id: "2-2", tipo: "Placa", medio: "TSA", precio: 17.00 },
      { id: "2-3", tipo: "Frasco", medio: "Agar Nutritivo", precio: 21.00 },
      { id: "2-4", tipo: "Caldo", volumen: "100ml", precio: 17.00 },
      { id: "2-5", tipo: "Caldo", volumen: "500ml", precio: 52.00 },
    ],
    viabilidad: "> 95%",
  ...
  },
  {
    ...
    presentaciones: [
      { id: "3-1", tipo: "Placa", medio: "Agar Nutritivo", precio: 14.00 },
      { id: "3-2", tipo: "Placa", medio: "TSA", precio: 16.00 },
      { id: "3-3", tipo: "Frasco", medio: "Agar Nutritivo", precio: 20.00 },
      { id: "3-4", tipo: "Caldo", volumen: "100ml", precio: 16.00 },
      { id: "3-5", tipo: "Caldo", volumen: "500ml", precio: 50.00 },
    ],
    viabilidad: "> 94%",
  ...
  },
  {
    ...
    presentaciones: [
      { id: "4-1", tipo: "Placa", medio: "Agar Nutritivo", precio: 15.00 },
      { id: "4-2", tipo: "Placa", medio: "TSA", precio: 17.00 },
      { id: "4-3", tipo: "Frasco", medio: "Agar Nutritivo", precio: 21.00 },
      { id: "4-4", tipo: "Caldo", volumen: "100ml", precio: 17.00 },
      { id: "4-5", tipo: "Caldo", volumen: "500ml", precio: 52.00 },
    ],
    viabilidad: "> 96%",
  ...
  },
  {
    ...
    presentaciones: [
      { id: "5-1", tipo: "Placa", medio: "Agar Nutritivo", precio: 14.00 },
      { id: "5-2", tipo: "Placa", medio: "TSA", precio: 16.00 },
      { id: "5-3", tipo: "Frasco", medio: "Agar Nutritivo", precio: 20.00 },
      { id: "5-4", tipo: "Caldo", volumen: "100ml", precio: 16.00 },
      { id: "5-5", tipo: "Caldo", volumen: "500ml", precio: 50.00 },
    ],
    viabilidad: "> 95%",
  ...
  },
  {
    ...
    presentaciones: [
      { id: "6-1", tipo: "Placa", medio: "Agar Nutritivo", precio: 15.00 },
      { id: "6-2", tipo: "Placa", medio: "TSA", precio: 17.00 },
      { id: "6-3", tipo: "Frasco", medio: "Agar Nutritivo", precio: 21.00 },
      { id: "6-4", tipo: "Caldo", volumen: "100ml", precio: 17.00 },
      { id: "6-5", tipo: "Caldo", volumen: "500ml", precio: 52.00 },
    ],
    viabilidad: "> 97%",
  ...
  },
  {
    ...
    presentaciones: [
      { id: "7-1", tipo: "Placa", medio: "Agar Nutritivo", precio: 15.00 },
      { id: "7-2", tipo: "Placa", medio: "TSA", precio: 17.00 },
      { id: "7-3", tipo: "Frasco", medio: "Agar Nutritivo", precio: 21.00 },
      { id: "7-4", tipo: "Caldo", volumen: "100ml", precio: 17.00 },
      { id: "7-5", tipo: "Caldo", volumen: "500ml", precio: 52.00 },
    ],
    viabilidad: "> 96%",
  ...
  },
  {
    ...
    presentaciones: [
      { id: "8-1", tipo: "Placa", medio: "Agar Nutritivo", precio: 15.00 },
      { id: "8-2", tipo: "Placa", medio: "TSA", precio: 17.00 },
      { id: "8-3", tipo: "Frasco", medio: "Agar Nutritivo", precio: 21.00 },
      { id: "8-4", tipo: "Caldo", volumen: "100ml", precio: 17.00 },
      { id: "8-5", tipo: "Caldo", volumen: "500ml", precio: 52.00 },
    ],
    viabilidad: "> 95%",
    concentracion: "1.8 x 10^9 UFC/ml",
    almacenamiento: "2-8°C, 10 meses",
  ...
  },
  {
    ...
    presentaciones: [
      { id: "9-1", tipo: "Placa", medio: "Agar Nutritivo", precio: 16.00 },
      { id: "9-2", tipo: "Placa", medio: "TSA", precio: 18.00 },
      { id: "9-3", tipo: "Frasco", medio: "Agar Nutritivo", precio: 22.00 },
      { id: "9-4", tipo: "Caldo", volumen: "100ml", precio: 18.00 },
      { id: "9-5", tipo: "Caldo", volumen: "500ml", precio: 54.00 },
    ],
    viabilidad: "> 94%",
  ...
  },
  {
    ...
    presentaciones: [
      { id: "10-1", tipo: "Placa", medio: "Agar Nutritivo", precio: 16.00 },
      { id: "10-2", tipo: "Placa", medio: "TSA", precio: 18.00 },
      { id: "10-3", tipo: "Frasco", medio: "Agar Nutritivo", precio: 22.00 },
      { id: "10-4", tipo: "Caldo", volumen: "100ml", precio: 18.00 },
      { id: "10-5", tipo: "Caldo", volumen: "500ml", precio: 54.00 },
    ],
    viabilidad: "> 93%",
  ...
  },
  {
    ...
    presentaciones: [
      { id: "11-1", tipo: "Placa", medio: "Agar Nutritivo", precio: 15.00 },
      { id: "11-2", tipo: "Placa", medio: "TSA", precio: 17.00 },
      { id: "11-3", tipo: "Frasco", medio: "Agar Nutritivo", precio: 21.00 },
      { id: "11-4", tipo: "Caldo", volumen: "100ml", precio: 17.00 },
      { id: "11-5", tipo: "Caldo", volumen: "500ml", precio: 52.00 },
    ],
    viabilidad: "> 96%",
...
export default function CepaDetailClient({ cepaId }: { cepaId: string }) {
  ...
  const generateWhatsAppMessage = () => {
    const items = cart.map(item => `${item.cepaNombre} - ${item.presentacionInfo} x${item.cantidad} ($${(item.precio * item.cantidad).toFixed(2)})`).join("%0A")
    return `Hola, quisiera hacer un pedido:%0A%0A${items}%0A%0ATotal: $${total.toFixed(2)}`
  }
