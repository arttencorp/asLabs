        ...
        <section data-navbar-theme="dark" className="relative overflow-hidden bg-[#071815] px-4 pb-20 pt-28 text-white sm:px-6 sm:pb-24 sm:pt-32 lg:px-8">
          ...
          <div className="relative mx-auto grid max-w-7xl items-center gap-10 lg:min-h-[510px] lg:grid-cols-[1.02fr_.98fr]">
            <motion.div initial={{ opacity: 0, y: 28 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: .75, ease: [0.16, 1, 0.3, 1] }}>
              ...
              <Image src="/images/excellent-logo-transparent.png" alt="exCELLent" width={2172} height={724} priority className="mt-7 h-auto w-[178px] brightness-0 invert sm:w-[220px]" />
              ...
              <div className="mt-7 flex flex-col gap-3 sm:flex-row">
                <WhatsAppContact message="Hola, quisiera cotizar un análisis molecular con exCELLent." className="group inline-flex min-h-14 items-center justify-center gap-3 rounded-full bg-[#80dfbf] px-7 text-sm font-bold text-[#09241d] shadow-[0_16px_38px_rgba(75,196,156,.2)] transition hover:-translate-y-1 hover:bg-[#a3efd7]">Evaluar mi muestra<ArrowRight className="h-4 w-4 transition-transform group-hover:translate-x-1" /></WhatsAppContact>
            ...
            <motion.div initial={{ opacity: 0, x: 30 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: .12, duration: .85, ease: [0.16, 1, 0.3, 1] }} className="relative h-[330px] sm:h-[400px] lg:h-[470px]">
              <div className="absolute inset-x-0 top-0 h-[86%] overflow-hidden rounded-[28px] border border-white/10 bg-white/5 shadow-[0_35px_100px_rgba(0,0,0,.3)] sm:inset-x-8 lg:left-10 lg:right-0">
                <Image src="/research/research-lab.png" alt="Especialista de exCELLent trabajando en análisis molecular" fill priority className="object-cover" sizes="(min-width: 1024px) 46vw, 100vw" />
        ...
        <section className="mx-auto max-w-7xl px-4 pt-24 sm:px-6 sm:pt-28 lg:px-8">
          <div className="grid gap-4 lg:grid-cols-[1.1fr_.9fr]">
            <Link href="/excellent/catalogo" className="group relative min-h-[390px] overflow-hidden rounded-[32px] bg-[#123a31] p-7 text-white shadow-[0_20px_70px_rgba(15,55,45,.13)] sm:p-9">
              <Image src="/laboratory-research.png" alt="Catálogo de análisis moleculares exCELLent" fill className="object-cover opacity-50 transition duration-700 group-hover:scale-105 group-hover:opacity-60" sizes="(min-width:1024px) 58vw, 100vw" />
          ...
          <div className="overflow-hidden rounded-[36px] border border-black/[.07] bg-white shadow-[0_24px_80px_rgba(18,59,49,.08)]">
            <div className="grid lg:grid-cols-[.88fr_1.12fr]">
              <div className="relative min-h-[390px] overflow-hidden lg:min-h-[640px]">
                <Image src="/modern-laboratory-scientists.png" alt="Equipo especializado en análisis moleculares exCELLent" fill className="object-cover transition duration-1000 hover:scale-[1.025]" sizes="(min-width:1024px) 44vw, 100vw" />
