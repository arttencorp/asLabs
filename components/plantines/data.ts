...
export const plantines: Plantin[] = [
  ...
  },
  {
    ...
    description:
      "Plantas micropropagadas in vitro (Hippeastrum spp.), uniformes y con alta sanidad fitosanitaria.",
    features: [
      "Alta uniformidad varietal",
      "Reducción de patógenos",
      "Mejor establecimiento",
      "Escalabilidad para producción masiva",
    ],
    available: true,
    isProduction: true,
    icon: Leaf,
    ...
    technicalData: {
      climate:
        "Templado, temperatura óptima 18–26 °C (evitar <12 °C sostenido)",
      soil: "Franco–arenoso, pH 6.0–7.0, alta materia orgánica, drenaje elevado",
      irrigation:
        "Moderado, preferible por goteo; evitar encharcamiento y periodos prolongados de saturación",
      fertilization:
        "NPK balanceado con énfasis en potasio; suplementación con calcio, magnesio y micronutrientes (B, Zn, Fe)",
      spacing:
        "0.20–0.30 m entre plantas × 0.40–0.60 m entre hileras (dependiente del calibre objetivo del bulbo)",
      maintenance:
        "Control de malezas, deshoje sanitario, tutorado si se induce floración, manejo de bulbo (curado y selección por calibre)",
      harvest:
        "Se entrega planta desarrollada con flores o para transplante en campo",
      storage: "Curado y selección por calibre según destino comercial",
      diseases: [
        "Pudrición basal por Fusarium",
        "Botrytis cinerea",
        "Manchas foliares por Stagonospora",
      ],
      benefits: [
        "Alta uniformidad varietal",
        "Reducción de carga inicial de patógenos",
        "Mejor establecimiento y crecimiento temprano",
        "Escalabilidad para producción masiva",
      ],
    },
  },
  {
    ...
    category: "Ornamentales",
    description:
      "Plantines in vitro en frasco, listos para aclimatación. Material clonal bajo condiciones controladas.",
    features: [
      "Alta uniformidad",
      "Producción clonal",
      "Calidad de planta",
    ...
    technicalData: {
      climate:
        "Invernadero o área protegida con buena ventilación y luz filtrada. Temperatura templado-cálida estable.",
      soil: "Alta aireación y drenaje (corteza, musgo, fibra de coco, carbón vegetal), libre de patógenos y sales.",
      irrigation:
        "Frecuente y moderado; permitir secado parcial del sustrato; agua de baja salinidad.",
      fertilization:
        "Soluciones balanceadas para ornamentales, en dosis bajas y fraccionadas.",
      spacing:
        "Separación suficiente para circulación de aire y control sanitario.",
      maintenance:
        "Eliminación de material senescente, desinfección de herramientas, monitoreo semanal.",
      harvest:
        "Floración dependiente de género y manejo; se optimiza con estabilidad ambiental.",
      storage:
        "Aclimatación: transición gradual desde in vitro con aumento progresivo de ventilación.",
      diseases: [
        "Manchas foliares",
        "Pudriciones blandas",
        "Trips",
      ...
      benefits: [
        "Alta uniformidad morfológica",
        "Desarrollo inicial controlado",
  ...
  },
  {
    ...
    category: "Frutales",
    description:
      "Plantas obtenidas por micropropagación in vitro, genéticamente uniformes y libres de patógenos.",
    features: [
    ...
    technicalData: {
      ...
      irrigation:
        "700–1,000 mm anuales, riego por goteo con manejo estricto de conductividad y pH",
      fertilization:
        "NPK balanceado bajo en nitratos, suplementado con calcio, magnesio, hierro y micronutrientes quelatados",
      spacing:
        "1.0–1.2 m entre plantas × 2.5–3.0 m entre hileras (2,800–4,000 plantas/ha)",
      maintenance:
        "Poda de formación y producción, control de malezas, mulching orgánico o plástico, monitoreo nutricional y fitosanitario",
      harvest: "Frutos de 1.5–3.0 g, recolección manual escalonada",
      storage:
        "Temperatura 0–1 °C, humedad relativa 90–95%, atmósfera controlada según destino comercial",
      diseases: [
        "Botrytis cinerea",
        "Phytophthora spp.",
        "Colletotrichum spp.",
      ...
      benefits: [
        "Alta sanidad vegetal",
        "Uniformidad fenotípica",
        "Mejor establecimiento y vigor inicial",
        "Mayor eficiencia productiva",
      ],
    },
  },
  ...
  },
  {
    ...
    category: "Bananos",
    description:
      "Revolución genética: banano completamente resistente a Fusarium R4T, el futuro de la bananicultura.",
    features: [
      "100% Resistente a Fusarium",
  ...
  // Plátanos - A cotizar
  {
    ...
    technicalData: {
      ...
      benefits: [
        "Alto contenido de antocianinas",
  ...
  // Otros cultivos - A cotizar
  {
    ...
    description:
      "Piña de variedad dorada con dulzor excepcional, perfecta para exportación y jugos premium.",
    features: [
      "Dulzor excepcional",
      "Alta jugosidad",
      "Calidad premium",
  ...
  },
  {
    ...
    category: "Otros Cultivos",
    description:
      "Fruta del dragón con demanda explosiva en mercados internacionales y precios excepcionales.",
    features: [
      "Alto valor comercial",
  ...
  },
  {
    ...
    category: "Otros Cultivos",
    description:
      "Fresas de alta calidad con producción continua y resistencia superior a enfermedades.",
    features: [
      "Alta calidad",
