        ...
        <div className="flex flex-col md:flex-row items-center">
          <div className="md:w-1/2 mb-8 md:mb-0">
            ...
            <h1 className="text-4xl font-bold text-[#2e7d32] mb-4">
              Revolucionando la agricultura peruana con biotecnología sostenible
            </h1>
            <p className="text-lg text-[#01283c] mb-6">
              Desde el año 2000, desarrollamos soluciones biotecnológicas innovadoras para mejorar la productividad
              agrícola y reducir el impacto ambiental.
            </p>
          ...
          <div className="md:w-1/2 relative">
            <div className="relative rounded-lg overflow-hidden shadow-lg">
              <Image
                src="/pitch-hero.png"
                alt="AS Laboratorios Biotecnología"
                width={600}
                height={400}
