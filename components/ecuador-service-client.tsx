...
const serviceFaqs = {
  molecular: [
    ...
    ["¿Todos los análisis se realizan en Quito?", "La recepción y coordinación se gestionan desde Quito. La extracción, amplificación, secuenciamiento y análisis especializado se procesan en nuestros laboratorios del Perú."],
