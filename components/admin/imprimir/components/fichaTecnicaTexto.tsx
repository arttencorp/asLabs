...
interface FichaTecnicaTextoProps {
  ficha: FichaTecnicaCompletaDatabase
}

export function FichaTecnicaTexto({ ficha }: FichaTecnicaTextoProps) {
  return (
    <div className="mx-auto max-w-[210mm] bg-white p-6 print:p-0 text-xs">
      <div className="border border-green-300 rounded-lg overflow-hidden">
        {/* Encabezado de la ficha técnica - igual que hardcodeados */}
        <div className="bg-[#5D9848] text-white p-3 flex items-center">
          ...
          <div>
            ...
            <p className="text-sm">CÓDIGO: {ficha.fit_tec_cod_vac || 'SIN CÓDIGO'}</p>
          </div>
        </div>

        {/* Contenido de la ficha técnica - formato exacto de hardcodeados */}
        <div className="p-4 bg-white text-xs">
          ...
          {/* 1. DATOS DEL PRODUCTOR - Contenido estático igual que hardcodeados */}
          <div className="mb-4">
          ...
          {/* 2. DATOS DE DISTRIBUCIÓN - Contenido estático igual que hardcodeados */}
          <div className="mb-4">
          ...
          <div className="grid grid-cols-2 gap-4 mb-4">
            {/* 3. TAXONOMÍA - Datos de BD con formato de tabla igual que hardcodeados */}
            <div>
          ...
          <div className="grid grid-cols-2 gap-4 mb-4">
            {/* 5. ZONA DE COLECTA DE GERMOPLASMA - Datos de BD con formato de tabla */}
            <div>
          ...
          {/* Pie de página - Contenido estático igual que hardcodeados */}
