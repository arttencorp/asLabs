    ...
    members: [
      {
        ...
        linkedIn: '#',
        bio: 'Antonio Víctor Gabriel Guevara Escobar es Bussiness Specialist por The Warthon School. Como COO en AS Labs se desempeña en áreas vinculadas a administración financiera y de personal. De forma paralela, ocupa una jefatura de departamento en Sparked Host LLC, empresa con sede en Utah, Estados Unidos, en la que interviene en procesos técnicos, marketing, diseño gestión de proyectos digitales y análisis de métricas internas.\n\nCuenta con competencias en en análisis de datos y ciencia computacional. Posee cursos y diplomados en comunicación científica, diseño visual, gestión empresarial, seguridad industrial, marketing digital y liderazgo de equipos técnicos. Además, posee dominio del español como lengua materna, inglés americano avanzado, inglés británico intermedio y conocimientos básicos de alemán.',
        education: [
    ...
    members: [
      {
        id: 'hassan-espinales',
        name: 'Andy Hassan',
        lastName: 'Espinales Gutiérrez',
        role: 'Jefe Microbiología Agroindustrial',
        area: 'Microbiología',
        image: '/team/andy-hassan.webp',
        email: 'ahassane@aslaboratorios.com',
        linkedIn: '#',
        bio: 'Andy Hassan Espinales Gutiérrez integra el equipo de AS Labs, donde participa en actividades vinculadas al ámbito de las ciencias de la vida, con proyección en entornos de trabajo técnico, académico y organizacional. Su formación y participación constante en espacios de actualización reflejan un perfil comprometido con el fortalecimiento de competencias aplicadas a la planificación, la comunicación efectiva y el desarrollo profesional dentro de organizaciones orientadas a la ciencia y la innovación.\n\nSu desempeño se caracteriza por una orientación al orden, la responsabilidad en la ejecución de actividades y la disposición para contribuir al cumplimiento de objetivos institucionales en contextos de exigencia técnica y organizativa. Esta combinación de formación, participación académica y compromiso institucional consolida un perfil alineado con los principios de mejora continua, aprendizaje permanente y aporte responsable al desarrollo de iniciativas científicas y técnicas.',
        education: [
          'Certificación en I Jornada de Ponencias en Ciencias de la Vida - AS Labs',
          'Participación Certificada en III Congreso Nacional sobre Ciencias de la Vida',
          'Participación Certificada en XXX Reunión Científica del ICBAR',
        ],
      },
      {
        id: 'jaime-ricardo',
      ...
      },
      {
        ...
        area: 'Técnica',
        image: '/team/hellem-guevara.webp',
    ...
    members: [
      {
        ...
        area: 'Prácticas',
        image: '/team/rosa-nancy-mejia.webp',
    ...
    members: [
      {
        ...
        area: 'Laboratorio',
        image: '/team/luis-alonso-flores.webp',
